...
const Orders = ({ order, orderStatuses, foodAreas, setFinishedOrder, setActiveOrder }) => {
  ...
  console.log("orderStatues",orderStatuses)
  console.log("foodAreas",foodAreas)
  console.log("setFinishedOrder",setFinishedOrder)
  console.log("setActiveOrder",setActiveOrder)
